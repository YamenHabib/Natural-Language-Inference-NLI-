...
from models import ROBERTAOnMRPC
import trainModels
...
if __name__ == "__main__":
    ...
    parser.add_argument("--best_model", default="MRPC_model.pkl",
                        help="Name of resulting model, model will be saved in 'output_dir'")
    parser.add_argument("--mertic_file", default="MRPC_metric.pkl",
                        help="Name of resulting model, model will be saved in 'output_dir'")
    ...
    parser.add_argument("--pretrained", default="MRPC_model.pkl",
    ...
    parser.add_argument("--num_epochs1", default=12, help="Number of epochs used to train new layers")
    parser.add_argument("--num_epochs2", default=36, help="Number of epochs used to train the whole new layers")
    parser.add_argument("--dropout_rate", default=0.40, help="Dropout rate")
    ...
    # Define model
    if args.from_file:
        model = ROBERTAOnMRPC( args.dropout_rate)
